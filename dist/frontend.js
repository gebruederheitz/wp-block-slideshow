...
var toPrimitive$8 = function (input, PREFERRED_STRING) {
  if (!isObject$k(input)) return input;
  var fn, val;
  if (PREFERRED_STRING && typeof (fn = input.toString) == 'function' && !isObject$k(val = fn.call(input))) return val;
  if (typeof (fn = input.valueOf) == 'function' && !isObject$k(val = fn.call(input))) return val;
  if (!PREFERRED_STRING && typeof (fn = input.toString) == 'function' && !isObject$k(val = fn.call(input))) return val;
...
var has$j = Object.hasOwn || function hasOwn(it, key) {
  return hasOwnProperty$2.call(toObject$7(it), key);
};
...
var EXISTS$1 = isObject$j(document$2) && isObject$j(document$2.createElement);
...
var ie8DomDefine$1 = !DESCRIPTORS$b && !fails$i(function () {
...
objectGetOwnPropertyDescriptor$1.f = DESCRIPTORS$a ? $getOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
  O = toIndexedObject$a(O);
  P = toPrimitive$7(P, true);
  if (IE8_DOM_DEFINE$3) try {
    return $getOwnPropertyDescriptor$2(O, P);
  } catch (error) { /* empty */ }
  if (has$i(O, P)) return createPropertyDescriptor$8(!propertyIsEnumerableModule$2.f.call(O, P), O[P]);
};
...
objectDefineProperty$1.f = DESCRIPTORS$9 ? $defineProperty$2 : function defineProperty(O, P, Attributes) {
  anObject$c(O);
...
var createNonEnumerableProperty$e = DESCRIPTORS$8 ? function (object, key, value) {
...
var setGlobal$7 = function (key, value) {
  try {
    createNonEnumerableProperty$d(global$q, key, value);
  } catch (error) {
    global$q[key] = value;
  } return value;
};
...
var getBuiltIn$8 = function (namespace, method) {
  return arguments.length < 2 ? aFunction$7(path$3[namespace]) || aFunction$7(global$k[namespace])
    : path$3[namespace] && path$3[namespace][method] || global$k[namespace] && global$k[namespace][method];
};
...
var createProperty$4 = function (object, key, value) {
  ...
  if (propertyKey in object) definePropertyModule$6.f(object, propertyKey, createPropertyDescriptor$6(0, value));
  else object[propertyKey] = value;
};

var getBuiltIn$6 = getBuiltIn$8;

var engineUserAgent$1 = getBuiltIn$6('navigator', 'userAgent') || '';
...
var nativeSymbol$1 = !!Object.getOwnPropertySymbols && !fails$g(function () {
  var symbol = Symbol();
...
var createWellKnownSymbol$1 = USE_SYMBOL_AS_UID$2 ? Symbol$3 : Symbol$3 && Symbol$3.withoutSetter || uid$4;

var wellKnownSymbol$j = function (name) {
  if (!has$d(WellKnownSymbolsStore$2, name) || !(NATIVE_SYMBOL$3 || typeof WellKnownSymbolsStore$2[name] == 'string')) {
    if (NATIVE_SYMBOL$3 && has$d(Symbol$3, name)) {
...
var arrayMethodHasSpeciesSupport$3 = function (METHOD_NAME) {
  ...
  return V8_VERSION$3 >= 51 || !fails$f(function () {
    var array = [];
...
var HAS_SPECIES_SUPPORT = arrayMethodHasSpeciesSupport$2('slice');
...
if (DESCRIPTORS$7 && !(NAME in FunctionPrototype)) {
...
var objectGetPrototypeOf = CORRECT_PROTOTYPE_GETTER ? Object.getPrototypeOf : function (O) {
  O = toObject$5(O);
  if (has$c(O, IE_PROTO$1)) return O[IE_PROTO$1];
...
var createIteratorConstructor$1 = function (IteratorConstructor, NAME, next) {
  ...
  IteratorConstructor.prototype = create$2(IteratorPrototype$1, { next: createPropertyDescriptor$5(1, next) });
...
var defineWellKnownSymbol$2 = function (NAME) {
  ...
  if (!has$9(Symbol, NAME)) defineProperty$1(Symbol, NAME, {
...
var setSymbolDescriptor = DESCRIPTORS$5 && fails$c(function () {
...
var $defineProperties = function defineProperties(O, Properties) {
  ...
  $forEach$1(keys, function (key) {
    if (!DESCRIPTORS$5 || $propertyIsEnumerable$1.call(properties, key)) $defineProperty$1(O, key, properties[key]);
  });
  return O;
};
...
if (!NATIVE_SYMBOL$2) {
  ...
  getOwnPropertyDescriptorModule$1.f = $getOwnPropertyDescriptor$1;
...
$$a({ global: true, wrap: true, forced: !NATIVE_SYMBOL$2, sham: !NATIVE_SYMBOL$2 }, {
  Symbol: $Symbol
});
...
$$a({ target: SYMBOL, stat: true, forced: !NATIVE_SYMBOL$2 }, {
  // `Symbol.for` method
...
$$a({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$2, sham: !DESCRIPTORS$5 }, {
  // `Object.create` method
  // https://tc39.es/ecma262/#sec-object.create
  create: $create,
  // `Object.defineProperty` method
...
$$a({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL$2 }, {
  // `Object.getOwnPropertyNames` method
  // https://tc39.es/ecma262/#sec-object.getownpropertynames
...
$$a({ target: 'Object', stat: true, forced: fails$c(function () { getOwnPropertySymbolsModule$1.f(1); }) }, {
...
if ($stringify) {
  var FORCED_JSON_STRINGIFY = !NATIVE_SYMBOL$2 || fails$c(function () {
    var symbol = $Symbol();
...
if (DESCRIPTORS$4 && typeof NativeSymbol == 'function' && (!('description' in NativeSymbol.prototype) ||
  ...
  defineProperty(symbolPrototype, 'description', {
    configurable: true,
    get: function description() {
      var symbol = isObject$c(this) ? this.valueOf() : this;
...
for (var COLLECTION_NAME$1 in DOMIterables$1) {
  var Collection$1 = global$e[COLLECTION_NAME$1];
...
$$7({ target: 'Reflect', stat: true, forced: FORCED$2, sham: FORCED$2 }, {
  construct: function construct(Target, args /* , newTarget */) {
    ...
    var instance = create(isObject$a(proto) ? proto : Object.prototype);
...
var Glide$1 = function (_Core) {
  ...
  createClass(Glide$$1, [{
    ...
    value: function mount() {
      ...
      return get$1(Glide$$1.prototype.__proto__ || Object.getPrototypeOf(Glide$$1.prototype), 'mount', this).call(this, _extends({}, COMPONENTS, extensions));
    }
  }]);
  return Glide$$1;
}(Glide);
...
var Symbol$1 = global$1$1.Symbol;
...
var parseDataAttribute = function parseDataAttribute(element, attributeName) {
...
var getBreakpoint = function getBreakpoint(element, name) {
  return parseDataAttribute(element, OPTION_NAMES.breakpoint[name], 'number', defaults.breakpoint[name]);
};
...
var getOptions = function getOptions(element) {
  ...
  var doAutoplayLarge = parseDataAttribute(element, OPTION_NAMES.autoplay.large, 'boolean', defaults.autoplay.large);
  var doAutoplayMedium = parseDataAttribute(element, OPTION_NAMES.autoplay.medium, 'boolean', defaults.autoplay.medium);
  var doAutoplaySmall = parseDataAttribute(element, OPTION_NAMES.autoplay.small, 'boolean', defaults.autoplay.small);
  var isCenteredLarge = parseDataAttribute(element, OPTION_NAMES.centerMode.large, 'boolean', defaults.centerMode.large);
  var isCenteredMedium = parseDataAttribute(element, OPTION_NAMES.centerMode.medium, 'boolean', defaults.centerMode.medium);
  var isCenteredSmall = parseDataAttribute(element, OPTION_NAMES.centerMode.small, 'boolean', defaults.centerMode.small);
  return {
    type: 'carousel',
    animationDuration: 800,
    bound: true,
    startAt: parseDataAttribute(element, OPTION_NAMES.initialSlide, 'number', defaults.initialSlide),
    perView: parseDataAttribute(element, OPTION_NAMES.slidesToShow.large, 'number', defaults.slidesToShow.large),
    focusAt: isCenteredLarge ? 'center' : 0,
    gap: parseDataAttribute(element, OPTION_NAMES.gap.large, 'number', 0),
    autoplay: doAutoplayLarge ? parseDataAttribute(element, OPTION_NAMES.autoplaySpeed, 'number', defaults.autoplaySpeed) : false,
    hoverpause: parseDataAttribute(element, OPTION_NAMES.pauseOnHover, 'boolean', defaults.pauseOnHover),
    rewind: parseDataAttribute(element, OPTION_NAMES.infinite.large, 'boolean', defaults.infinite.large),
    peek: parseDataAttribute(element, OPTION_NAMES.edgePadding.large, 'number', defaults.edgePadding.large),
    breakpoints: (_breakpoints = {}, _defineProperty(_breakpoints, getBreakpoint(element, 'small'), {
      perView: parseDataAttribute(element, OPTION_NAMES.slidesToShow.small, 'boolean', defaults.slidesToShow.small),
      focusAt: isCenteredSmall ? 'center' : 0,
      rewind: parseDataAttribute(element, OPTION_NAMES.infinite.small, 'boolean', defaults.infinite.small),
      peek: parseDataAttribute(element, OPTION_NAMES.edgePadding.small, 'number', defaults.edgePadding.small),
      autoplay: doAutoplaySmall ? parseDataAttribute(element, OPTION_NAMES.autoplaySpeed, 'number', defaults.autoplaySpeed) : false,
      gap: parseDataAttribute(element, OPTION_NAMES.gap.small, 'number', 0)
    }), _defineProperty(_breakpoints, getBreakpoint(element, 'medium'), {
      perView: parseDataAttribute(element, OPTION_NAMES.slidesToShow.medium, 'boolean', defaults.slidesToShow.medium),
      focusAt: isCenteredMedium ? 'center' : 0,
      rewind: parseDataAttribute(element, OPTION_NAMES.infinite.medium, 'boolean', defaults.infinite.medium),
      peek: parseDataAttribute(element, OPTION_NAMES.edgePadding.medium, 'number', defaults.edgePadding.medium),
      autoplay: doAutoplayMedium ? parseDataAttribute(element, OPTION_NAMES.autoplaySpeed, 'number', defaults.autoplaySpeed) : false,
      gap: parseDataAttribute(element, OPTION_NAMES.gap.medium, 'number', 0)
    }), _breakpoints)
  };
};
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (slider.childElementCount) {
        this.slideshows.push(new Slideshow(slider, debugEnabled, resizeListener));
      }
    } // window.__debug = this;
...
var Slideshow = /*#__PURE__*/function (_Debuggable) {
  ...
  function Slideshow(sliderRoot) {
    ...
    _this = _super.call(this, 'slideshow');
    ...
    var options = getOptions(_this.sliderRoot);

    _this.applyDomTransformations();

    _this.glide = new Glide$1(_this.sliderRoot, options);

    _this.debug.log('Setup complete', _this.glide);

    if (sliderRoot.parentElement.matches('.ghwp-stage')) {
      _this.debug.log('Stage slider identified');

      _this.glide.on('build.after', _this.onStageAfterBuild);
    }
  ...
  _createClass(Slideshow, [{
    ...
    key: "hasArrows",
    value: function hasArrows() {
      var res = parseDataAttribute(this.sliderRoot, OPTION_NAMES.arrows, 'boolean', true);
      return res;
    }
  }, {
    key: "hasDots",
    value: function hasDots() {
      return parseDataAttribute(this.sliderRoot, OPTION_NAMES.dots.small, 'boolean', defaults.dots.small);
    }
  }, {
    key: "onStageAfterBuild",
    value: function onStageAfterBuild() {
      this.debug.log('After build event callback from glide.js');
      var placeholder = $$3()('.ghwp-slideshow--skeleton');
      this.debug.log({
    ...
    key: "wantsWrapper",
    value: function wantsWrapper() {
      return parseDataAttribute(this.sliderRoot, OPTION_NAMES.withWrapper, 'string', false);
    }
  }, {
    key: "wrapSlides",
...
export { Slideshow as GlideSlideshow, SlideshowFactory as GlideSlideshowFactory, defaults, imageGallery, nextIcon, prevIcon };
